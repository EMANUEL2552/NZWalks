...
namespace NZWalks.API.Migrations
{
    ...
    [Migration("20240818164540_Seed data for difficulties and Regions")]
            ...
            modelBuilder.Entity("NZWalks.API.Models.Domain.Difficulty", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("78a553b7-7dd2-483e-bd19-091db1450847"),
                            Name = "Easy"
                        },
                        new
                        {
                            Id = new Guid("f0637c0e-3376-46f7-b9f1-74730273e23d"),
                            Name = "Medium"
                        },
                        new
                        {
                            Id = new Guid("72a98726-6f46-41ca-a979-17deeee4c052"),
                            Name = "Hard"
                        });
                });
            ...
            modelBuilder.Entity("NZWalks.API.Models.Domain.Region", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a797e2b-14b3-4f72-a03b-e655627eb305"),
                            Code = "ACK",
                            Name = "Auckland",
            ...
            modelBuilder.Entity("NZWalks.API.Models.Domain.Walk", b =>
                {
                    ...
                    b.HasOne("NZWalks.API.Models.Domain.Difficulty", "Region")
                        .WithMany()
